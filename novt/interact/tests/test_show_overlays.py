...
try:
    ...
    from novt.interact import show_overlays as u
except ImportError:
    bqplot = None
    ipw = None
    u = None
...
class TestShowOverlays(object):
    ...
    def test_clear_overlays(self, overlay_controls):
        ...
        overlay_controls._show_footprint(
            ['NIRSpec'], overlay_controls.nirspec_controls)
    ...
    def test_load_clear_catalog(self, overlay_controls):
        ...
        overlay_controls.toggle_catalog(
            overlay_controls.catalog_buttons[0], None, None)
    ...
    def test_load_catalog_error(self, overlay_controls, bad_catalog_file):
        overlay_controls.uploaded_data.catalog_file = {
            'file_obj': bad_catalog_file}
        overlay_controls._load_catalog()
    ...
    @pytest.mark.parametrize('inst',
                             ['NIRSpec', 'NIRCam Short', 'NIRCam Long'])
