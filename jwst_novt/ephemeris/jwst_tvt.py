...
class Ephemeris:
    def __init__(self, start_date=Time("2021-12-26"), end_date=Time("2024-10-03")):
        ...
        self.ephemeris_filename = os.path.join(
            os.path.dirname(__file__), "ephemeris_2021-12-26_2024-10-03.csv"
        )  # set filename to local copy by default
    ...
    def get_ephemeris_data(self, start_date, end_date):
        ...
        try:
            ...
            print(
                "No internet connection, using local file: {}".format(
    ...
    def get_fixed_target_positions(self, ra, dec):
        ...
        if ":" in ra:
            ra = self.convert_ddmmss_to_float(ra) * 15.0
