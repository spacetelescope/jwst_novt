...
class TestStyleApplication:
    ...
    def test_init(self, image_viewer, uploaded_data,
                  nirspec_controls, nircam_controls, timeline_controls,
                  overlay_controls, save_controls, context):
    ...
    def test_link(self, application_style):
        ...
        test_values = {'ra': 240, 'dec': -80, 'color1': 'orange',
                       'color2': 'purple', 'name': 'test'}
        ...
        application_style.nirspec_controls.color_primary = \
            test_values['color1']
        assert (application_style.timeline_controls.nirspec_color
                == test_values['color1'])

        # from nircam
        application_style.nircam_controls.color_primary = test_values['color2']
        assert (application_style.timeline_controls.nircam_color
                == test_values['color2'])

        # from uploaded data
        application_style.uploaded_data.image_file_name = test_values['name']
        assert (application_style.timeline_controls.center
                == test_values['name'])
    ...
    def test_update_from_config(self, application_style):
        ...
        nrs_config = {'ra': 100.0, 'color_primary': 'red',
        ...
        assert (application_style.nirspec_controls.color_primary
